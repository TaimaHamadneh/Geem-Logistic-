...
class EmployeeNotificatiosPage extends StatefulWidget {
  final String userId;
  final UserCredential userCredential;
  final String merchantId;
  final String signedInUserEmail;

  const EmployeeNotificatiosPage({Key? key, required this.userId,
  ...
  @override
  State<EmployeeNotificatiosPage> createState() => _NotificatiosPageState();
}

class _NotificatiosPageState extends State<EmployeeNotificatiosPage> {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
       ...
       Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => EmployeeNotificatiosPage(
