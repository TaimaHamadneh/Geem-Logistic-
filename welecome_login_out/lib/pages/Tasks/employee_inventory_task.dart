...
class EmployeeInventoryTasks extends StatefulWidget {
  final String userId;
  final UserCredential userCredential;

  EmployeeInventoryTasks({Key? key, required this.userCredential, required this.userId})
      : super(key: key);
...
class _ManageEmployeeState extends State<EmployeeInventoryTasks> {
