 ...
 Future<void> fetchEmployees() async {
  ...
  Future<void> addTask() async {
    if (_formKey.currentState!.validate()) {
      final urlReq = url + 'employee/$selectedEmployee/tasks';
      final response = await http.post(
        ...
        body: jsonEncode(<String, dynamic>{
          ...
          'DeadlineDate': selectedContractStart.toString(),
...
String uniqueId = '${DateTime.now().millisecondsSinceEpoch}';
             ...
             //  await FirebaseMessaging.instance.subscribeToTopic('employees');
           await sendNotfiy("New Task Added ",
                "A new task has been added successfully!", uniqueId);
           addNotification('New Task Added', 'Check your Task Now !', now.toString() ,uniqueId);
...
labelStyle: TextStyle(fontSize: isDesktop ? 22 : 18, color: Colors.black),                      ),
                      child: selectedContractStart != null
                          ...
                          : Text('Deadline date',style:TextStyle(fontSize: isDesktop ? 22 : 18, color: Colors.black), 
                          ),
                    ),
                  ),
                ),
