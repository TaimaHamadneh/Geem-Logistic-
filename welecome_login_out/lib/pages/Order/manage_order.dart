...
import 'package:welecome_login_out/pages/Order/add_order.dart';
...
class _OrderPageState extends State<OrderPage> {
  ...
  void filterOrders(String query) {
    setState(() {
      filteredOrders = orders.where((order) {
        ...
        return orderId.contains(lowerCaseQuery) ||
  ...
  Widget _buildOrderCard(Map<String, dynamic> order) {
    ...
    return Card(
        margin: EdgeInsets.symmetric(vertical: isDesktop? 20: 8.0, horizontal: isDesktop? 200 :16.0),
              ...
              children: [
                ...
                IconButton(
                    ...
                    onPressed: () {
                      ...
                      String dataToCopy =
                          "Order ID: $orderId, Status: $orderStatus,  Date: $orderDate";
                      Clipboard.setData(ClipboardData(text: dataToCopy));
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                            content: Text(
                                "Order ID, date and status copied to clipboard")),
                      );
                    }),
              ],
            ),
              ...
              children: [
                ...
                IconButton(
                  icon:  Icon(Icons.arrow_circle_right_outlined,
                      size: isDesktop? 40: 30, color: Approved.PrimaryColor),
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        Padding(
          ...
          child: SizedBox(
            width: isDesktop ? 1500 : double.infinity,
          ...
          child: Padding(
            ...
            child: isLoading
                ...
                : filteredOrders.isEmpty
                    ?  Center(child: Text('No orders available', style: TextStyle(color: Colors.black,
                fontSize: isDesktop? 22: 18)
                ,))
                    : RefreshIndicator(
